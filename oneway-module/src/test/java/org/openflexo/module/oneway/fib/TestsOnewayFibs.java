...
public class TestsOnewayFibs extends GenericFIBTestCase {
	...
	public TestsOnewayFibs(Resource fibResource, String name) {
	...
	public static void instanciateTestServiceManager(/*Class<? extends TechnologyAdapter>... taClasses*/)
		...
		assertNotNull(getBPMNEditorViewPoint());
	...
	public static VirtualModel getBPMNEditorViewPoint() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		return serviceManager.getVirtualModelLibrary().getVirtualModel(OWConstants.BPMN_EDITOR_URI);
	}
