 ...
 * 
 * A {@link FlexoProject} has the {@link EAProject} nature if it contains at least a view conform to oneway viewpoint<br>
 * The first found view will be considered as the Oneway View
 * 
 * @author sylvain
 */
public class OnewayProjectNatureFactory extends DefaultProjectNatureFactoryImpl<OnewayProjectNature> {

	static final Logger logger = FlexoLogger.getLogger(OnewayProjectNatureFactory.class.getPackage().getName());

	public OnewayProjectNatureFactory() {
		super(OnewayProjectNature.class);
	}

	@Override
	public OnewayProjectNature givesNature(FlexoProject<?> project, FlexoEditor editor) {
		GivesOnewayNature givesEANature = GivesOnewayNature.actionType.makeNewAction(project, null, editor);
