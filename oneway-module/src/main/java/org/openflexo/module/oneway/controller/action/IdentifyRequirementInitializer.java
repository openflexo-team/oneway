 ...
 * @author sylvain
 */
public class IdentifyRequirementInitializer extends ActionInitializer<IdentifyRequirement, OnewayProjectNature, FlexoObject> {
	...
	@Override
	protected FlexoActionRunnable<IdentifyRequirement, OnewayProjectNature, FlexoObject> getDefaultInitializer() {
		return (e, action) -> {
	...
	@Override
	protected FlexoActionRunnable<IdentifyRequirement, OnewayProjectNature, FlexoObject> getDefaultFinalizer() {
		return (e, action) -> {
