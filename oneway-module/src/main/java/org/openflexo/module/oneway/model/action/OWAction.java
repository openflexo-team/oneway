...
/**
 * Abstract implementation for a {@link FlexoAction} specific to {@link OWModule} module
 * 
 * @author sylvain
 */
public abstract class OWAction<A extends FlexoAction<A, T1, T2>, T1 extends FlexoObject, T2 extends FlexoObject>
		extends FlexoAction<A, T1, T2> implements ModuleSpecificFlexoAction<OWModule> {
	 ...
	 * @param editor
	 */
	public OWAction(FlexoActionFactory<A, T1, T2> actionFactory, T1 focusedObject, List<T2> globalSelection, FlexoEditor editor) {
	 ...
	 * @param editor
	 */
	public OWAction(T1 focusedObject, List<T2> globalSelection, FlexoEditor editor) {
	...
	public LocalizedDelegate getLocales() {
		try {
			return ((ApplicationContext) getServiceManager()).getModuleLoader().getModuleInstance(OWModule.class).getLocales();
