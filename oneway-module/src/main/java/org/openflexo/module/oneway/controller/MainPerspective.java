...
import org.openflexo.module.oneway.widget.OnewayProjectBrowser;
import org.openflexo.view.controller.FlexoController;

/**
 * Generic perspective for Oneway module
 * 
 * @author sylvain
 */
public class MainPerspective extends OnewayPerspective {
	...
	protected AbstractOnewayProjectBrowser makeOnewayProjectBrowser() {
		return new OnewayProjectBrowser(getController());
	}
}
