...
/**
 * Main view for BPMN perspective
 */
@SuppressWarnings("serial")
public class BPMNModuleView extends FIBModuleView<OnewayProjectNature> {

	public static Resource BPMN_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/BPMNMainPanel.fib");

	private final FlexoPerspective perspective;

	public BPMNModuleView(OnewayProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
		super(nature, controller, BPMN_MODULE_VIEW_FIB, controller.getModule().getLocales());
	...
	public static class BPMNModuleViewFIBController extends OWFIBController {
		public BPMNModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory) {
			super(component, viewFactory);
		}

		public BPMNModuleViewFIBController(FIBComponent component, GinaViewFactory<?> viewFactory, FlexoController controller) {
			super(component, viewFactory, controller);
		}

		public ImageIcon getProjectIcon() {
			return IconFactory.getImageIcon(OWIconLibrary.OW_BIG_ICON, OWIconLibrary.BPMN_BIG_MARKER);
		}

		public ImageIcon getBPMNElementMappingIcon() {
			return IconFactory.getImageIcon(OWIconLibrary.ELEMENT_BIG_ICON, OWIconLibrary.BPMN_BIG_MARKER);
		}
