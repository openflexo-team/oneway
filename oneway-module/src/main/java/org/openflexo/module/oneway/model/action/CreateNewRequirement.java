 ...
 * @author sylvain
 */
public class CreateNewRequirement extends OWAction<CreateNewRequirement, FlexoConceptInstance, FlexoObject> {
	...
	protected void doAction(final Object context) throws FlexoException {
		...
		getFocusedObject().getPropertyChangeSupport().firePropertyChange(OWConstants.REQUIREMENT_PROPERTY_NAME, false, true);
	}
